/**
 * @author <various people on the Internet>
 * @link <http://altlasten.lutz.donnerhacke.de/mitarb/lutz/usenet/Rainer.html>
 */
...
char* poem[] = {
    ...
    "und ruft: All Ihr Paeckchen, Ihr sorgt Euch zu viel,",
